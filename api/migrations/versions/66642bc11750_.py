...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("tg_settings", postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "difficulty",
            sa.Enum("easy", "medium", "hard", "challenging", name="difficulty"),
            nullable=True,
        ),
    ...
    op.bulk_insert(
        sa.table("role", sa.Column("name", sa.String), sa.Column("permissions", JSON)),
        roles,
    )
